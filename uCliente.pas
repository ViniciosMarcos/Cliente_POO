...
begin
  ...
  Try
    Try
      ...
      QryAdicionar.SQL.Add('INSERT INTO CLIENTE (nome, cgc, logradouro, bairro, ');
      QryAdicionar.SQL.Add(' uf, data_nascimento, cep, telefone)');
      QryAdicionar.SQL.Add('VALUES (:nome, :cgc, :logradouro, :bairro, ');
      QryAdicionar.SQL.Add(' :uf, :data_nas, :cep, :telefone)');
      QryAdicionar.ParamByName('nome').AsString       := cliente.FNome;
      QryAdicionar.ParamByName('cgc').AsInteger       := cliente.FCPFCNPJ;
...
begin
  ...
  Try
    Try
      ...
      QryAtualizar.SQL.Add('SET nome = :nome, cgc = :cgc, logradouro = :logradouro,');
      ...
      QryAtualizar.ParamByName('cgc').AsInteger       := cliente.FCPFCNPJ;
...
begin
  ...
  Try
    ...
    QryBuscar.Close;
    QryBuscar.SQL.Clear;
    QryBuscar.SQL.Add('Select id, nome, cgc, logradouro, bairro, uf,');
    QryBuscar.SQL.Add('       data_nascimento, cep, telefone');
    QryBuscar.SQL.Add('From CLIENTE ');
    QryBuscar.SQL.Add('WHERE cgc = :cgc');
    QryBuscar.ParamByName('cgc').AsInteger := cpf;
    QryBuscar.Open;
